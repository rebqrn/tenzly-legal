...
**Service Description**
Loopline provides automated SMS text responses on behalf of businesses when an incoming phone call is not answered. Messages are sent only in direct response to an inbound call placed by the recipient.

**Consent**
By calling a business phone number that uses Loopline's service, the caller consents to receive one automated text message reply related to that call. Message and data rates may apply.
